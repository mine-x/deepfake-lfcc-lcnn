...
#  about the data sets
trn_set_name = 'asvspoof5_trn'
val_set_name = 'asvspoof5_dev'

# for convenience
#  we will use resources in this directory
# Set the ASVSPOOF5_DATASET env var to point at your dataset root,
# otherwise defaults to ~/asvspoof5_dataset
tmp = os.environ.get("ASVSPOOF5_DATASET", os.path.expanduser("~/asvspoof5_dataset"))
...
input_dirs = [tmp + '/flac_T'] #/flac_T, /flac_D, and flac_E_eval

# print("[DEBUG] tmp:", tmp)
# print("[DEBUG] input_dirs:", input_dirs)
...
optional_argument = [tmp + '/asvspoof5_protocols/ASVspoof5.train.tsv',
                     tmp + '/asvspoof5_protocols/ASVspoof5.dev.track_1.tsv']

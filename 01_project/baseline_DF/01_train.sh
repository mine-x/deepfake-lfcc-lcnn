#!/bin/bash
########################
# Training with ASVspoof 2019 pre-trained weights
# Adapted from 00_train.sh with adjusted workers/batch size
#
# Usage:
...
log_train="../../train_pretrained_$(date +%Y%m%d_%H%M%S).log"
...
echo "Training with pre-trained weights: ${pretrained_model}"
echo "Log: ${log_train}"
